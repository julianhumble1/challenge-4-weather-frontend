  ...
  return (
      <div className="container col-lg-4 col-md-6 col-12">
          ...
          <div className="row align-items-center justify-content-center">
              ...
              <a href="" className="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover col-auto px-0 text-start">Saved Location Link</a>
        </div>
    </div>
  )
}
